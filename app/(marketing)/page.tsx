  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/dashboard" className="inline-flex items-center gap-2 bg-white text-blue-700 font-semibold px-8 py-4 rounded-lg hover:bg-blue-50 transition shadow-lg">
                Start Free Trial →
              </Link>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center px-6">
        ...
        <Link href="/dashboard" className="inline-flex bg-white text-blue-700 font-semibold px-10 py-4 rounded-lg hover:bg-blue-50 transition shadow-lg text-lg">
          Get Started Free →
        </Link>
      </section>
